    ...
    <div className="w-full px-[100px] py-[50px] h-[1000px] bg-gradient-to-b from-white to-indigo-600">
      <div className="mt-[75px] text-center">
        ...
        <p className="mt-5 justify-center">
          ...
          voluptates reprehenderit quaerat, laboriosam harum atque voluptatem
          quasi placeat illum a officia unde beatae earum dolore blanditiis iure
          dolorum quidem.
        </p>
      </div>
      <div className="mt-[80px] grid grid-cols-3 justify-items-center text-white">
        <div className="w-[350px] rounded-lg overflow-hidden bg-slate-700 shadow-lg mb-[40px]">
          <div className="px-6 py-4 ">
            ...
            <div className="font-bold text-6xl my-10">
              <h1>$ 19.99</h1>
            </div>
        ...
        <div className="w-[350px] rounded-lg overflow-hidden bg-slate-700 shadow-lg mb-[40px]">
          <div className="px-6 py-4 ">
            <h1 className="text-lg text-grey-900">Business</h1>
            <div className="font-bold text-6xl my-10">
              <h1>$ 39.99</h1>
            </div>
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>Dapat analisis hasil penjualan dengan CHART</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
        ...
        <div className="w-[350px] rounded-lg overflow-hidden bg-slate-700 shadow-lg mb-[40px]">
          <div className="px-6 py-4 ">
            <h1 className="text-lg text-grey-900">Entrepreneur</h1>
            <div className="font-bold text-6xl my-10">
              <h1>$ 69.99</h1>
            </div>
            <ul role="list" className="mb-8 space-y-4 text-left">
      ...
      <h1 className="text-white text-center">
        ...
        <a href="aw" className="text-blue-200">
          Get in touch
        </a>
      </h1>
    </div>
